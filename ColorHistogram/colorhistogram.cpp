...
ColorHistogram::ColorHistogram(const QImage &_image):image(_image),scale(1.0) {
    setScene(&scene);
...
void ColorHistogram::keyPressEvent(QKeyEvent *evt) {
...
void ColorHistogram::mouseMoveEvent(QMouseEvent *evt) {
